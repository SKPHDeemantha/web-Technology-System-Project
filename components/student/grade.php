...
<head>
    ...
    <link rel="stylesheet" href="..\..\assets\css\studentcss\grade.css">
</head>
<body>
    <!-- Header -->
    <div class="header">
    ...
    <div class="container">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <a href="grade.php" class="nav-item active" onclick="navigateTo('grades')">
                <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <main class="main-content">
            <!-- Grades Page -->
            <div id="grades-page" class="page active">
                <div class="grades-container">
                    <h2>Grades</h2>

                    <div class="card-overview">
                        <h3><i class="fas fa-chart-line"></i> Grade Overview</h3>
                        <div class="overview">
                            <div class="overview-item">Current GPA: <span>3.8</span></div>
                            <div class="overview-item">Total Credits: <span>45</span></div>
                            <div class="overview-item">Grade Points: <span>171</span></div>
                        </div>
                    </div>

                    <div class="card">
                        <h3><i class="fas fa-book"></i> Course Breakdown</h3>
                        <table id="gradesTable">
                            ...
                            <tbody>
                                <!-- Sample data - would be filled by JS in real application -->
                                <tr>
                                    <td data-label="Course">
                                        <div class="course-badge">CS101</div>
                                        <div>Introduction to Programming</div>
                                    </td>
                                    <td data-label="Assignment">Final Project</td>
                                    <td data-label="Grade"><span class="grade-excellent">A</span></td>
                                    <td data-label="Date">Dec 15, 2024</td>
                                </tr>
                                <tr>
                                    <td data-label="Course">
                                        <div class="course-badge">MATH202</div>
                                        <div>Calculus II</div>
                                    </td>
                                    <td data-label="Assignment">Midterm Exam</td>
                                    <td data-label="Grade"><span class="grade-good">B+</span></td>
                                    <td data-label="Date">Nov 10, 2024</td>
                                </tr>
                                <tr>
                                    <td data-label="Course">
                                        <div class="course-badge">PHY105</div>
                                        <div>Physics for Engineers</div>
                                    </td>
                                    <td data-label="Assignment">Lab Report 5</td>
                                    <td data-label="Grade"><span class="grade-average">B-</span></td>
                                    <td data-label="Date">Oct 28, 2024</td>
                                </tr>
                                <tr>
                                    <td data-label="Course">
                                        <div class="course-badge">ENG101</div>
                                        <div>Academic Writing</div>
                                    </td>
                                    <td data-label="Assignment">Research Paper</td>
                                    <td data-label="Grade"><span class="grade-excellent">A-</span></td>
                                    <td data-label="Date">Dec 5, 2024</td>
                                </tr>
                                <tr>
                                    <td data-label="Course">
                                        <div class="course-badge">CS205</div>
                                        <div>Data Structures</div>
                                    </td>
                                    <td data-label="Assignment">Algorithm Analysis</td>
                                    <td data-label="Grade"><span class="grade-good">B+</span></td>
                                    <td data-label="Date">Nov 22, 2024</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
    ...
    <script src="..\..\assets\js\student\grade.js"></script>
