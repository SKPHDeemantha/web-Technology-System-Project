...
<body>
    ...
    <div class="container">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <a href="../components/student/profile.php" class="nav-item" onclick="navigateTo('profile')">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path
            ...
            <a href="../components/student/course.php" class="nav-item" onclick="navigateTo('courses')">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path d="M5 13.18v4L12 21l7-3.82v-4L12 17l-7-3.82zM12 3L1 9l11 6 9-4.91V17h2V9L12 3z" />
                </svg>
                Courses
            </a>
            <a href="../components/student/grade.php" class="nav-item" onclick="navigateTo('grades')">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path d="M16 6l2.29 2.29-4.88 4.88-4-4L2 16.59 3.41 18l6-6 4 4 6.3-6.29L22 12V6z" />
                </svg>
                Grades
            </a>
            <a href="../components/student/attendence.php" class="nav-item" onclick="navigateTo('attendance')">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path
            ...
            <a href="../components/student/schedule.php" class="nav-item" onclick="navigateTo('schedule')">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path
            ...
            <a href="../components/student/assignments.php" class="nav-item" onclick="navigateTo('assignments')">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path
            ...
            <a href="../components/student/message.php" class="nav-item" onclick="navigateTo('messages')">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path
            ...
            <a href="../components/student/announcements.php" class="nav-item" onclick="navigateTo('announcements')">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path
            ...
            <a href="../components/student/resources.php" class="nav-item" onclick="navigateTo('resources')">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path
                        d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z" />
                </svg>
            ...
            <a href="../components/student/setting.php" class="nav-item" onclick="navigateTo('settings')">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path
