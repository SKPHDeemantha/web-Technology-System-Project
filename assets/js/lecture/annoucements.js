...
let announcements = [
  {
    ...
    content:
      "The midterm exam for CS101 has been rescheduled to next Friday. Please check the updated timetable.",
  ...
  },
  {
    ...
    content:
      "Due to technical issues, the deadline for Assignment 3 has been extended by 48 hours.",
  ...
  },
  {
    ...
    content:
      "We have a special guest lecture on AI Ethics scheduled for next Wednesday. Attendance is mandatory.",
  ...
  },
  {
    ...
    content:
      "This week's lab session is cancelled due to maintenance work in the computer lab.",
    course: "CS101 - Introduction to Programming",
    priority: "urgent",
    status: "active",
                ...
                <div class="d-flex justify-content-between align-items-start mb-2">
                    <div class="flex-grow-1">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            )} me-2">${announcement.priority.toUpperCase()}</span>
                            ${
                              announcement.scheduled
                                ? '<span class="badge bg-warning me-2"><i class="fas fa-clock me-1"></i>SCHEDULED</span>'
                                : ""
                            }
                            <span class="badge bg-${
                              announcement.status === "active"
                                ? "success"
                                : "info"
                            }">${announcement.status.toUpperCase()}</span>
                        </div>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="#" onclick="editAnnouncement(${
                              announcement.id
                            })"><i class="fas fa-edit me-2"></i>Edit</a></li>
                            <li><a class="dropdown-item" href="#" onclick="duplicateAnnouncement(${
                              announcement.id
                            })"><i class="fas fa-copy me-2"></i>Duplicate</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item text-danger" href="#" onclick="deleteAnnouncement(${
                              announcement.id
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="announcement-meta">
                        <small class="text-muted">
                            ...
                            <i class="fas fa-calendar ms-3 me-1"></i>${formatDate(
                              announcement.createdAt
                            )}
                        </small>
                    </div>
                    <div class="announcement-actions">
                        <button class="btn btn-sm btn-outline-purple me-1" onclick="viewAnalytics(${
                          announcement.id
                        })">
            ...
            ${data
              .map(
                ...
                <div class="flex-fill d-flex flex-column align-items-center">
                    <div class="bg-purple rounded-top" style="width: 20px; height: ${
                      (value / maxValue) * 100
                    }%;"></div>
...
function createAnnouncement() {
  ...
  const newAnnouncement = {
    ...
    course: document.querySelector(
      `#announcementCourse option[value="${course}"]`
    ).text,
    priority,
...
function toggleAnnouncementStatus(id) {
  ...
  if (announcement) {
    ...
    showToast(
      `Announcement ${
        announcement.status === "active" ? "activated" : "paused"
      }!`,
      "info"
    );
  }
