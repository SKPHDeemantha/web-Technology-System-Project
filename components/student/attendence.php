...
<head>
    ...
    <link rel="stylesheet" href="..\..\assets\css\studentcss\attendence.css">
</head>
<body>
    <!-- Header -->
    <div class="header">
    ...
    <div class="container">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <a href="attendence.php" class="nav-item active" onclick="navigateTo('attendance')">
                <svg viewBox="0 0 24 24" fill="currentColor">
    ...
    <script src="..\..\assets\js\student\attendence.js"></script>
</body>
</html>