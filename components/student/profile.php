...
<head>
    ...
    <link rel="stylesheet" href="..\..\assets\css\studentcss\profile.css">
</head>
<body>
    <!-- Header -->
    <div class="header">
    ...
    <div class="container">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <a href="profile.php" class="nav-item active" onclick="navigateTo('profile')">
                <svg viewBox="0 0 24 24" fill="currentColor">
            ...
            <div id="profile-page" class="page active">
                ...
                <div class="profile-layout">
                    ...
                    <div class="card profile-card">
                        ...
                        <div class="student-id">Student ID: 2021CS001</div>
                        <div class="tag-container"><span class="tag">Computer Science</span></div>

                        <div class="info-list">
                            <div><i class="fas fa-envelope"></i> heshan.d@university.edu</div>
                            <div><i class="fas fa-phone"></i> +1 (555) 123-4567</div>
                            <div><i class="fas fa-map-marker-alt"></i> San Francisco, CA</div>
                            <div><i class="fas fa-calendar-alt"></i> Enrolled: Sep 2021</div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="section-header">
                            ...
                            <button class="edit-btn" onclick="openProfileModal()"><i class="fas fa-edit"></i> Edit</button>
                        </div>

                        <div class="info-grid">
                            <div>
                                <h4>Full Name</h4>
                                <p>Heshan Deemantha</p>
                            </div>
                            <div>
                                <h4>Email</h4>
                                <p>heshandeemantha@example.com</p>
                            </div>
                            <div>
                                <h4>Date of Birth</h4>
                                <p>March 15, 2002</p>
                            ...
                            <div>
                                <h4>Address</h4>
                                <p>123 University Street<br>Colombo, Sri Lanka</p>
                            </div>
                            <div>
                                <h4>Nationality</h4>
                                <p>Sri Lankan</p>
                    ...
                    <div class="card achievements-card">
                        ...
                        <ul>
                            <li><i class="fas fa-award"></i> Dean’s List - Fall 2024</li>
                            <li><i class="fas fa-medal"></i> Hackathon Winner - 1st Place</li>
                            <li><i class="fas fa-certificate"></i> Completed Machine Learning Certification</li>
                        </ul>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" id="fullName" name="fullName" value="Heshan Deemantha" required>
                            </div>
                            <div class="form-group">
                                <label for="email">Email</label>
                                <input type="email" id="email" name="email" value="heshandeemantha@example.com" required>
                            </div>
                            <div class="form-group">
                                <label for="dateOfBirth">Date of Birth</label>
                                <input type="date" id="dateOfBirth" name="dateOfBirth" value="2002-03-15" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="nationality" name="nationality" value="Sri Lankan" required>
                            </div>
                        </div>
                        <div class="form-group full-width">
                            <label for="address">Address</label>
                            <textarea id="address" name="address" rows="3" required>123 University Street
Colombo, Sri Lanka</textarea>
                        </div>
                        <div class="form-group full-width">
                            <label for="emergencyContact">Emergency Contact</label>
                            <input type="tel" id="emergencyContact" name="emergencyContact" value="+1 (555) 987-6543" required>
                        </div>
                    </div>
                </form>
            </div>
