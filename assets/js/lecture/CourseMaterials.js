...
function renderMaterialsGrid() {
  ...
  materialsGrid.innerHTML = materials
    .map(
      (material) => `
        <div class="material-item card mb-3" data-id="${
          material.id
        }" data-type="${material.type}" data-course="${
        material.course.split(" - ")[0]
      }">
            <div class="card-body">
        ...
        material.color
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="material-meta">
                                <small class="text-muted">
                                    ...
                                    <i class="fas fa-database ms-3 me-1"></i>${
                                      material.size
                                    }
                                </small>
                            </div>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="#" onclick="downloadMaterial(${
                              material.id
                            })"><i class="fas fa-download me-2"></i>Download</a></li>
                            <li><a class="dropdown-item" href="#" onclick="shareMaterial(${
                              material.id
                            })"><i class="fas fa-share me-2"></i>Share</a></li>
                            <li><a class="dropdown-item" href="#" onclick="editMaterial(${
                              material.id
                            })"><i class="fas fa-edit me-2"></i>Edit</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item text-danger" href="#" onclick="deleteMaterial(${
                              material.id
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <small class="text-muted">Uploaded ${formatDate(
                      material.uploaded
                    )}</small>
                </div>
            </div>
  ...
  setTimeout(() => {
    ...
    const newMaterial = {
      ...
      course: document.querySelector(
        `#materialCourse option[value="${course}"]`
      ).text,
      size: "2.1 MB",
      downloads: 0,
      uploaded: new Date(),
...
function searchMaterials(query) {
  ...
  materialItems.forEach((item) => {
    ...
    const materialDescription = item
      ...
      .textContent.toLowerCase();
    const materialCourse = item
      .querySelector(".material-meta")
      .textContent.toLowerCase();
