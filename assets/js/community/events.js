...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.getElementById('createEventForm') && !document.getElementById('eventsTableBody')) {
...
function initializeEventsPage() {
            ...
            row.innerHTML = `
                    ...
                    <div class="d-flex align-items-center">
                        <div class="me-3">
                            <div class="bg-primary text-white rounded p-2 text-center" style="width: 50px;">
                                ...
                                <small>${eventDate.toLocaleDateString('en-US', { month: 'short' })}</small>
                            </div>
                        </div>
                        <div>
                ...
                <td>
                    <div class="event-actions">
                        ...
                        <button class="btn btn-sm btn-outline-secondary edit-event" data-id="${event.id}">
    ...
    function updateEventStats() {
        ...
        if (thisMonthEventsCount) thisMonthEventsCount.textContent = thisMonthEvents.length;
    ...
    function performSearch() {
        ...
        if (filteredEvents.length === 0) {
            ...
            showToast(`Found ${filteredEvents.length} event(s) matching "${searchTerm}"`, 'success');
        }
    }
                    ...
                    <div class="col-md-8">
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="mb-3">
                                    <span class="badge bg-secondary me-2">${event.type.charAt(0).toUpperCase() + event.type.slice(1)}</span>
                                    <small class="text-muted">
                                        <i class="fas fa-calendar me-1"></i>${formattedDate} at ${event.time}
                                    </small>
                                </div>
                                <div class="mb-3">
...
function initializeEventActions(event, allEvents) {
    ...
    if (joinBtn) {
        joinBtn.addEventListener('click', function() {
            ...
            // Update display
            document.querySelector('.fa-users').nextElementSibling.textContent = event.attendees;
        });
    }
...
function updatePreview() {
    ...
    if (previewElement) {
        previewElement.innerHTML = `
            ...
            <p>${description}</p>
            <small>Date: ${new Date(date).toLocaleDateString()} at ${time}</small>
        `;
    }
}
