                ...
                <td>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#" onclick="viewMember('${
                              member.name
                            }')">View Profile</a></li>
                            <li><a class="dropdown-item" href="#" onclick="changeRole('${
                              member.name
                            }')">Change Role</a></li>
                            <li><a class="dropdown-item text-danger" href="#" onclick="removeMember('${
                              member.name
                            }')">Remove</a></li>
                        </ul>
                    </div>
  ...
  const groups = [
    {
      ...
      type: "Channel",
      description: "General discussions about computer science",
      private: false,
      members: 25,
    },
    {
      name: "Study Group A",
      type: "Group",
      description: "Group for algorithm studies",
      private: true,
      members: 8,
    },
    {
      ...
      type: "Channel",
      description: "Channel for project collaborations",
      private: false,
      members: 15,
    },
  ];
            ...
            <div class="col-md-4 mb-3">
                <div class="group-card">
                    <div class="group-icon">
                        <i class="fas fa-${
                          group.type === "Channel" ? "hashtag" : "users"
                        }"></i>
                    </div>
                    <h6>${group.name}</h6>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge bg-${
                          group.private ? "warning" : "success"
                        }">${group.private ? "Private" : "Public"}</span>
                    </div>
                    <div class="mt-2">
                        <button class="btn btn-sm btn-outline-primary me-1" onclick="joinGroup('${
                          group.name
                        }')">Join</button>
                        <button class="btn btn-sm btn-outline-secondary" onclick="viewGroup('${
                          group.name
                        }')">View</button>
                    </div>
                </div>
...
function setupEventListeners() {
  ...
  document
    .getElementById("communitySettingsForm")
    .addEventListener("submit", function (e) {
      e.preventDefault();
      saveSettings();
    });
