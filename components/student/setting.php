...
<body>
                    ...
                    <div class="card">
                        ...
                        <div class="settings-grid">
                            ...
                            <div class="setting-item">
                                ...
                                <input type="email" id="email" value="heshandeemantha@example.com">
                            </div>
                            <div class="setting-item">
                    ...
                    <div class="card">
                        ...
                        <div class="settings-list">
                            ...
                            <div class="toggle-item">
                                ...
                                <label class="switch">
                                    <input type="checkbox" name="assignmentReminders" checked>
                                    <span class="slider"></span>
                                </label>
                            </div>
                            <div class="toggle-item">
                                ...
                                <label class="switch">
                                    <input type="checkbox" name="announcementAlerts" checked>
                                    <span class="slider"></span>
                                </label>
                            </div>
                        </div>
    ...
    <style>
        ...
        .danger-card .section-header .icon {
    ...
    <script src="..\..\assets\js\student\setting.js"></script>
</body>
</html>
