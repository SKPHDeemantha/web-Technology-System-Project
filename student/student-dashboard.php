...
<body>
        ...
        <div class="header-icons">
            ...
            <div class="dropdown">
                <button class="icon-btn" id="notificationBtn">
                    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M12 2C10.9 2 10 2.9 10 4V4.29C7.12 5.14 5 7.82 5 11V17L3 19V20H21V19L19 17V11C19 7.82 16.88 5.14 14 4.29V4C14 2.9 13.1 2 12 2ZM12 6C14.76 6 17 8.24 17 11V18H7V11C7 8.24 9.24 6 12 6ZM10 21C10 22.1 10.9 23 12 23C13.1 23 14 22.1 14 21H10Z" />
                    </svg>
                ...
                <div class="dropdown-content notification-dropdown">
                    ...
                    <div class="notification-item">
                        <p>New assignment posted in Math 101</p>
                        <span class="time">2 hours ago</span>
                    </div>
                    <div class="notification-item">
                        <p>Grade updated for Physics 202</p>
                        <span class="time">1 day ago</span>
                    </div>
                    <div class="notification-item">
                        <p>Upcoming exam reminder</p>
                        <span class="time">3 days ago</span>
                    </div>
                    <div class="notification-item">
                        <p>Community event invitation</p>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content profile-dropdown">
                    ...
                    <hr>
                    <a href="../components/student/profile.html">View Profile</a>
                    <a href="../components/student/setting.html">Settings</a>
    ...
    <div class="container">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <a href="../components/student/profile.html" class="nav-item" onclick="navigateTo('profile')">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path
            ...
            <a href="../components/student/course.html" class="nav-item" onclick="navigateTo('courses')">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path d="M5 13.18v4L12 21l7-3.82v-4L12 17l-7-3.82zM12 3L1 9l11 6 9-4.91V17h2V9L12 3z" />
                </svg>
                Courses
            </a>
            <a href="../components/student/grade.html" class="nav-item" onclick="navigateTo('grades')">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path d="M16 6l2.29 2.29-4.88 4.88-4-4L2 16.59 3.41 18l6-6 4 4 6.3-6.29L22 12V6z" />
                </svg>
                Grades
            </a>
            <a href="../components/student/attendence.html" class="nav-item" onclick="navigateTo('attendance')">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path
            ...
            <a href="../components/student/schedule.html" class="nav-item" onclick="navigateTo('schedule')">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path
            ...
            <a href="../components/student/assignments.html" class="nav-item" onclick="navigateTo('assignments')">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path
            ...
            <a href="../components/student/message.html" class="nav-item" onclick="navigateTo('messages')">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path
            ...
            <a href="../components/student/announcements.html" class="nav-item" onclick="navigateTo('announcements')">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path
            ...
            <a href="../components/student/resources.html" class="nav-item" onclick="navigateTo('resources')">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path
                        d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z" />
                </svg>
            ...
            <a href="../components/student/setting.html" class="nav-item" onclick="navigateTo('settings')">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path
                ...
                <section class="performance">
                    ...
                    <div class="quick-actions">
                        ...
                        <button class="btn-blue-outline"
                            onclick="window.location.href='../components/student/course.html'">Register for
                            Course</button>
                        <button class="btn-green-outline"
                            onclick="window.location.href='../components/student/assignments.html'">Submit
                            Assignment</button>
                        <button class="btn-lightblue-outline"
                            onclick="window.location.href='../components/student/message.html'">Message
                            Instructor</button>
                        <button class="btn-yellow-outline">Book Appointment</button>
                        <button class="btn-grey-outline"
                            onclick="window.location.href='../components/student/resources.html'">Download
                            Resources</button>
                    </div>
                </section>
            </div>
    ...
    <script src="../assets/js/student/studentDashboard.js"></script>
    ...
    <footer id="main-footer" class="footer" role="contentinfo">
        ...
        <div class="footer-container">
            ...
            <div class="footer-section logo-section">
                ...
                <p class="description">
                    Empowering education through innovative technology. Connect, learn, and grow with our comprehensive
                    university platform.
                </p>
            </div>
