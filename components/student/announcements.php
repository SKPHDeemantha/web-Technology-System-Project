...
<head>
    ...
    <link rel="stylesheet" href="..\..\assets\css\studentcss\announcements.css">
...
<body>
    ...
    <div class="container">
        <aside class="sidebar" id="sidebar">
            ...
            <a href="announcements.php" class="nav-item active" onclick="navigateTo('announcements')">
                <svg viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="setting.html" class="nav-item" onclick="navigateTo('settings')">
                <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <main class="main-content">
            <!-- Announcements Page -->
            <div id="announcements-page" class="page active">
                <div class="page-content">
                    ...
                    <div class="announcement-tabs">
                        ...
                        <button class="tab" data-category="important">Important</button>
                        <button class="tab" data-category="academic">Academic</button>
                        <button class="tab" data-category="events">Events</button>
                        <button class="tab" data-category="administration">Administration</button>
                    </div>
                    ...
                    <div class="announcements-list">
                        ...
                        <div class="announcement-card" data-category="important">
                            ...
                            <h2 class="announcement-title">Campus Closure Notice</h2>
                            <div class="announcement-content">
                                Due to severe weather conditions, the university campus will be closed tomorrow, January 15th, 2024. All classes are cancelled, and administrative offices will be closed.
                            </div>
                            <div class="announcement-meta">
                                <div class="meta-left">
                                    <span>Posted: Jan 14, 2024 2:30 PM</span>
                                    <a href="#" class="meta-link">Admin Office</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="announcement-card" data-category="academic">
                            ...
                            <h2 class="announcement-title">Mid-term Examination Schedule Released</h2>
                            <div class="announcement-content">
                                The mid-term examination schedule for Spring 2024 has been published. Students are advised to check their individual schedules and prepare accordingly.
                            </div>
                            <ul class="announcement-list">
                                <li><strong>Mathematics:</strong> March 15-17</li>
                                <li><strong>Physics:</strong> March 20-22</li>
                                <li><strong>Chemistry:</strong> March 25-27</li>
                            </ul>
                            <div class="announcement-meta">
                                <div class="meta-left">
                                    <span>Posted: Jan 12, 2024 9:00 AM</span>
                                    <a href="#" class="meta-link">Academic Affairs</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="announcement-card" data-category="events">
                            ...
                            <h2 class="announcement-title">Career Fair 2024 - Registration Open</h2>
                            <div class="announcement-content">
                                Join us for the Annual Career Fair on February 10th, 2024. Meet representatives from top companies and explore internship and job opportunities.
                            </div>
                            <div class="announcement-details">
                                <div><strong>Date:</strong> February 10, 2024</div>
                                <div><strong>Time:</strong> 9:00 AM - 5:00 PM</div>
                                <div><strong>Venue:</strong> Main Auditorium</div>
                            </div>
                            <div class="announcement-content">
                                <strong>Participating Companies:</strong>
                            </div>
                            <div class="company-list">
                                <div class="company-item">TechCorp Inc.</div>
                                <div class="company-item">DataSys Solutions</div>
                                <div class="company-item">InnoTech Labs</div>
                            </div>
                            <div class="announcement-actions">
                                <button class="action-btn primary">Register</button>
                                <button class="action-btn">Mark as Read</button>
                            </div>
                            <div class="announcement-meta">
                                <div class="meta-left">
                                    <span>Posted: Jan 10, 2024 11:00 AM</span>
                                    <a href="#" class="meta-link">Career Services</a>
                                </div>
                            </div>
                        </div>

                        <!-- Administration Announcement -->
                        <div class="announcement-card" data-category="administration">
                            <div class="announcement-header">
                                <span class="announcement-badge badge-admin">Administration</span>
                            </div>
                            <h2 class="announcement-title">Library Renovation Update</h2>
                            <div class="announcement-content">
                                The central library renovation project is progressing ahead of schedule. The new study areas will be available starting February 1st, 2024. Temporary arrangements remain in effect until completion.
                            </div>
                            <div class="announcement-meta">
                                <div class="meta-left">
                                    <span>Posted: Jan 8, 2024 3:45 PM</span>
                                    <a href="#" class="meta-link">Facilities Management</a>
                                </div>
                            </div>
                        </div>

                        <!-- Additional Academic Announcement -->
                        <div class="announcement-card" data-category="academic">
                            <div class="announcement-header">
                                <span class="announcement-badge badge-academic">Academic</span>
                            </div>
                            <h2 class="announcement-title">New Course Offerings - Spring 2024</h2>
                            <div class="announcement-content">
                                The university is pleased to announce new course offerings for the Spring 2024 semester. Registration for these courses will open next week.
                            </div>
                            <ul class="announcement-list">
                                <li><strong>CS 455:</strong> Advanced Machine Learning</li>
                                <li><strong>PHY 320:</strong> Quantum Computing Fundamentals</li>
                                <li><strong>BIO 280:</strong> Environmental Biotechnology</li>
                            </ul>
                            <div class="announcement-actions">
                                <button class="action-btn primary">View Course Catalog</button>
                            </div>
                            <div class="announcement-meta">
                                <div class="meta-left">
                                    <span>Posted: Jan 5, 2024 10:30 AM</span>
                                    <a href="#" class="meta-link">Registrar's Office</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="..\..\assets\js\student\announcements.js"></script>
